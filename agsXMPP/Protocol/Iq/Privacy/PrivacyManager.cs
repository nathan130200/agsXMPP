...
namespace agsXMPP.Protocol.iq.privacy
{
	...
	public class PrivacyManager
	{
		...
		{
			this.RemoveList(name, null, null);
		}
		...
		{
			this.DeclineActiveList(null, null);
		}
		...
		{
			this.ChangeActiveList(name, null, null);
		}
		...
		{
			this.ChangeDefaultList(name, null, null);
		}
		...
		{
			this.DeclineDefaultList(null, null);
		}
		...
		{
			this.UpdateList(name, rules, null, null);
		}
		...
		{
			this.AddList(name, rules, null, null);
		}
		...
		{
			this.UpdateList(name, rules, cb, cbArg);
		}
		...
		{
			if (cb == null)
				this.m_connection.Send(pIq);
			else
				this.m_connection.IqGrabber.SendIq(pIq, cb, cbArg);
		}
