...
namespace AgsXMPP.Protocol.x
{
	...
	public class Event : Element
	{
		...
		public bool Offline
		{
			get { return this.HasTag("offline"); }
			set
			{
				this.RemoveTag("offline");
				if (value)
					this.AddTag("offline");
			}
		...
		{
			get { return this.HasTag("delivered"); }
			set
			{
				this.RemoveTag("delivered");
				if (value)
					this.AddTag("delivered");
			}
		...
		{
			get { return this.HasTag("displayed"); }
			set
			{
				this.RemoveTag("displayed");
				if (value)
					this.AddTag("displayed");
			}
		...
		{
			get { return this.HasTag("composing"); }
			set
			{
				this.RemoveTag("composing");
				if (value)
					this.AddTag("composing");
			}
		...
		public string Id
		{
			get { return this.GetTag("id"); }
			set { this.SetTag("id", value); }
		}
