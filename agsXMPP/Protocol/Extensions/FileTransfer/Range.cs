...
namespace AgsXMPP.Protocol.Extensions.FileTransfer
{
	...
	public class Range : Element
	{
		...
		*/
		...
		public long Offset
		{
			get { return this.GetAttributeLong("offset"); }
			set { this.SetAttribute("offset", value.ToString()); }
		}
		...
		public long Length
		{
			get { return this.GetAttributeLong("length"); }
			set { this.SetAttribute("length", value.ToString()); }
		}
	}
}
