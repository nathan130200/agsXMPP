...
namespace AgsXMPP.Protocol.Extensions.FileTransfer
{
	...
	public class File : Element
	{
		...
		*/
		...
		public long Size
		{
			get { return this.GetAttributeLong("size"); }
			set { this.SetAttribute("size", value.ToString()); }
		}
		...
		public string Hash
		{
			get { return this.GetAttribute("hash"); }
			set { this.SetAttribute("hash", value); }
		}
		...
		public DateTime Date
		{
			get
			{
				return Util.Time.FromISO(this.GetAttribute("date"));
			}
			set
			{
				this.SetAttribute("date", Util.Time.ToISO(value));
			}
		}
		...
		public Range Range
		{
			get
			{
				var range = this.SelectSingleElement(typeof(Range));
				if (range != null)
