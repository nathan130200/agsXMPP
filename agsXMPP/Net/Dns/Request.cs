...
namespace AgsXMPP.Net.Dns
{
	...
	public class Request
	{
		...
		{
			get { return this._recursionDesired; }
			set { this._recursionDesired = value; }
		}
		...
		public Request()
		{
			...
			this._recursionDesired = true;
			this._opCode = Opcode.StandardQuery;
		...
		public byte[] GetMessage()
		{
			...
			// write the bitfields
			data.Add((byte)(((byte)this._opCode << 3) | (this._recursionDesired ? 0x01 : 0)));
			data.Add((byte)0);
