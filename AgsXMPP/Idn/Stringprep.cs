...
namespace AgsXMPP.Idn
{
	...
	/// strings. It supports the following stringprep profiles: <b>RFC3491 nameprep</b>,
	/// <b>RFC3920 XMPP nodeprep and resourceprep</b>.
	...
	public class Stringprep
	{
		...
		/// <exception cref="StringprepException">If the name cannot be prepped with this profile.</exception>
		/// </returns>
		public static string NamePrep(string input, bool allowUnassigned)
		{
			...
			// Bidi handling
			var r = Contains(s, RFC3454.D1);
			var l = Contains(s, RFC3454.D2);
